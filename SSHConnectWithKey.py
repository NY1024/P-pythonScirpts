...
def connect(user,host,keyfile,release):
    ...
    try:
        ...
        ssh_newkey = 'Are you sure you want to continut'
        conn_closed = 'Connction clse by remote host'
...
def main():
    ...
    parser.add_option('-u',dest='user',type=string,help='specify thr user')
    ...
    for filename in os.listdir(passDir):
        ...
        if Fails > 5:
            ...
            print '[!]Adjust nmebr of simutaneous threads'
            exit(0)
